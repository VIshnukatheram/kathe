...
useEffect( ()=>{
  if(POSContactData && customerData?.isPOS&&selectedSubType){
    ...
    PaymentReProcessingData[selectedSubType]?.POS_RequestDetails?.forEach(element => {
      ...
      <Spin spinning={isLoading} fullscreen />
        ...
        >
              ...
              >
                ...
                >
                  <Checkbox
                    ...
                    onChange={() =>
                      handleCheckBoxChange("NEFT")
                    }
                  ></Checkbox>
                </Form.Item>
              </Col>
            </Row>
              {isPaymentMethodSelection?.toLocaleLowerCase()==="neft"&&isSelectionMode!=="12"&&<>
          ...
          {isShowPOSScreen&&<>
            ...
            {isPaymentMethodSelection?.toLocaleLowerCase()==="neft"&&<>
              {renderDetailsForm("NEFT_Bank_Details")}
              </>}
              {isCheckOTP&&<>
